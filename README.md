...
- Suite frontend actual: 12 tests del capability shell, tema dinamico, formato regional y UI administrativa de configuracion, 0 fallos en `npm.cmd run test`, `npm.cmd run lint` y `npm.cmd run build`.
